...
import edu.neu.madcourse.ranchen.twoPlayerScraggle.TwoPlayerGameActivity;
...
public class WordBuilder {
    ...
    public WordBuilder(ArrayAdapter<String> adapter, TwoPlayerGameActivity parent) {
        this.output = adapter;
        this.parent = parent;
        this.loaded = false;
