...
public class PhaseTwo extends Activity {
    ...
    TwoPlayerGameActivity twoPlayerGameActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0; i < 9; i++) {
            ...
            newButton.setBackgroundColor(twoPlayerGameActivity.LETTER_BUTTON_BACKGROUND);
                    ...
                    if (previouslyPressed == null ||
                        ...
                        if (result.length() >= 2) {
                            ...
                            if (dictionary.contains(result) && !(output.indexOf(result) >= 0)) {
                                ...
                                addScore(result);
                                scoreButton.setText("" + score);
                                remoteClient.saveValue(pickPlayer.getPlayerUsingName(), score + "");
                                clearSelections();
                                clearWord();
                            }
                        }
    ...
    public void clearSelections() {
        ...
        for (int i =0; i < 9; i++) {
                ...
                b.setBackgroundColor(twoPlayerGameActivity.LETTER_BUTTON_BACKGROUND);
