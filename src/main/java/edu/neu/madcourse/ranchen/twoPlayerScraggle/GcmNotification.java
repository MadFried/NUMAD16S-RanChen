...
public class GcmNotification {
	...
	private void post(Map<String, String> params, List<String> regIds)
		...
		URL url;
		try {
			url = new URL(edu.neu.madcourse.ranchen.communication.CommunicationConstants.BASE_URL);
		} catch (MalformedURLException e) {
			throw new IllegalArgumentException("invalid url: "
					+ edu.neu.madcourse.ranchen.communication.CommunicationConstants.BASE_URL);
		}
